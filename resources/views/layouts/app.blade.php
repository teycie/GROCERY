...
<body class="antialiased bg-gray-50 text-gray-800 dark:bg-emerald-950 dark:text-slate-200 min-h-screen flex flex-col transition-colors duration-200">
    ...
    <!-- Footer -->
    <footer class="bg-green-700 dark:bg-emerald-950 text-white py-6 mt-auto border-t border-green-800 dark:border-green-900/60">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    <h3 class="text-lg font-bold text-green-100 dark:text-green-400 mb-4">Contact Us</h3>
                    <div class="space-y-3 text-sm">
                        <div class="flex items-center">
                            <svg class="h-5 w-5 mr-3 text-green-200 dark:text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg>
                            <a href="mailto:support@freshmart.com" class="text-green-100/90 dark:text-gray-300 hover:text-white transition">support@freshmart.com</a>
                        </div>
                        <div class="flex items-center">
                            <svg class="h-5 w-5 mr-3 text-green-200 dark:text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                            </svg>
                            <a href="tel:+1234567890" class="text-green-100/90 dark:text-gray-300 hover:text-white transition">+1 (234) 567-890</a>
                        </div>
                        <div class="flex items-center">
                            <svg class="h-5 w-5 mr-3 text-green-200 dark:text-green-400" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer" class="text-green-100/90 dark:text-gray-300 hover:text-white transition">Message via WhatsApp</a>
                        </div>
                    </div>
                </div>

                <div>
                    <h3 class="text-lg font-bold text-green-100 dark:text-green-400 mb-4">Follow Us</h3>
                    <div class="flex space-x-4 mb-4">
                        <a href="https://facebook.com/freshmart" target="_blank" rel="noopener noreferrer" class="text-green-100/90 dark:text-gray-300 hover:text-white transition transform hover:scale-110">
                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                            </svg>
                        </a>
                        <a href="https://instagram.com/freshmart" target="_blank" rel="noopener noreferrer" class="text-green-100/90 dark:text-gray-300 hover:text-white transition transform hover:scale-110">
                            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-green-100/90 dark:text-gray-400 text-xs">
