...
@section('content')
<!-- Hero Section -->
<div class="relative bg-white overflow-hidden rounded-2xl shadow-sm mb-12 border border-gray-100">
                ...
                <div class="sm:text-center lg:text-left">
                    ...
                    <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                        ...
                        <div class="mt-3 sm:mt-0 sm:ml-3">
                            <a href="{{ route('login') }}" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-green-700 bg-green-100 hover:bg-green-200 md:py-4 md:text-lg transition">
                                Log In
                            </a>
                        </div>
                    </div>
...
<!-- Features Section -->
<div class="mb-16">
    <h2 class="text-3xl font-bold text-center mb-10 text-gray-800">Why Choose FreshMart?</h2>
...
<div class="mb-12">
    <div class="flex justify-between items-center mb-8">
        ...
        <a href="{{ route('register') }}" class="text-green-600 hover:text-green-800 font-medium">Log in to buy &rarr;</a>
    </div>
    
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
        @forelse($products as $product)
            <div class="bg-white border rounded-xl overflow-hidden shadow-sm hover:shadow-md transition category-card flex flex-col">
        ...
        @empty
            <div class="col-span-full text-center py-10 bg-gray-50 rounded-xl">
                <p class="text-gray-500">Products are currently being restocked. Check back soon!</p>
            </div>
        @endforelse
    </div>
</div>
...
@if($announcements->count() > 0)
    <div class="bg-blue-50 rounded-xl border border-blue-100 p-8 mb-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            @foreach($announcements as $announcement)
                <div class="bg-white p-4 rounded-lg shadow-sm">
                    ...
                    <p class="text-sm text-gray-600 line-clamp-3">{{ $announcement->message }}</p>
                </div>
            @endforeach
        </div>
    </div>
