                ...
                <div class="pt-32 lg:pt-24">
                    ...
                    <div class="space-y-6 max-w-xl">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                <p class="text-sm font-bold text-gray-500 dark:text-slate-400 uppercase tracking-wide">Address</p>
                                <p class="text-base text-gray-900 dark:text-slate-100">{{ $user->address ?? 'Not provided' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
